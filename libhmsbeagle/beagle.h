...
/**
 * @brief Set a sparse generator matrix with majorization using non-zero entries
 *
...
/**
 * @brief Set a sparse differential matrix using non-zero entries
 *
 * This function sets a sparse matrix in an instance buffer.
 *
 * @param instance              Instance number (input)
 ...
 * @return error code
 */
BEAGLE_DLLEXPORT int beagleSetSparseDifferentialMatrix(int instance,
                                                       int matrixIndex,
                                                       const int *rowIndices,
                                                       const int *colIndices,
                                                       const double *values,
